...
### The core questions: 
1. How do people actually use bathrooms
2. What does friction look like in real routines and spaces?
...
**Mobile Diary Study**
- 18 participants via dscout. 
- Four structured activities covering smart device tours, bathroom tours, and morning/evening routine logging. 
- Captured the texture of real spaces without observer effect.

**Follow-up In-depth interviews**
- 12 participants
- Part 1: routine deep-dive
- Part 2: concept feedback on real CES 2026 products for an initial read on innovative bathroom technologies.
