...
There was a mix of household composition and bathroom sizes and we included a small subset of users with smart device already in the bathroom to understand behavior and pain points.<br><br>
...
<div class="cs-findings"> 
	<li> 
		...
		<span>
			Directly influenced research plan, shifting from a PM "wish list" to focusing on the right methods for informing concept development
		</span>
	</li>
	<li> 
		<span class="cs-finding-label">
			Co-defined concept territories
		</span>
		<span>
			1. Space-conscious hardware<br>
			2. Maximizing hands-free productivity<br>
			3. On-demand health guidance<br>
		</span>
	</li>
		<li> 
		<span class="cs-finding-label">
		...
		<span>
			Research informed creation of 7 distinct concepts, each with clear design audience that solved identified barriers. Three (3) of my ideas made to the final set of concepts. Advised elimination of concepts with little research-backing.
		</span>
	</li>
</div>
